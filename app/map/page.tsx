...
export default function MapPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-all duration-700 ${theme}`} data-theme={theme}>
      ...
      <main className="flex-1 flex flex-col md:relative md:overflow-hidden">
        {/* Map Background — desktop only */}
        <div className="hidden md:block absolute inset-0 bg-[#1a2f35]">
        ...
        <div className="md:hidden w-full h-40 bg-[#1a2f35] relative flex-shrink-0">
          <div className="absolute inset-0 opacity-40">
            <svg className="w-full h-full" viewBox="0 0 400 160" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M0,60 L50,50 L100,55 L150,45 L200,55 L250,48 L300,60 L350,52 L400,62 M0,90 L50,80 L100,88 L150,78 L200,88 L250,82 L300,92 L350,85 L400,95"
                stroke="#2a4a4f"
                strokeWidth="2"
                fill="none"
              />
        ...
        {/* Weather Card */}
        <div className="md:absolute md:top-8 md:left-8 md:w-[280px] w-full bg-[#0d1b1e] md:rounded-2xl md:border md:border-[#1a2f35] md:shadow-2xl border-b border-[#1a2f35]">
          <div className="p-5 md:p-6 overflow-y-auto md:max-h-[calc(100vh-8rem)]">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white mb-1 leading-snug">{location.city}</h2>
            <p className="text-gray-400 text-sm mb-3">{currentDay}, {currentTime}</p>
              ...
              <>
                <div className="mb-3">
                  <div className="flex items-end gap-2 mb-1">
                    <span className="text-4xl md:text-5xl font-bold text-white">{weather?.temperature}°</span>
                    <div className="pb-1">
                  ...
                  <p className="text-white text-sm mb-0.5">{weather?.condition}</p>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  <div className="text-center">
                    <svg className="w-5 h-5 text-[#00d4ff] mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => router.push('/')}
              className="w-full bg-[#2a4a4f] hover:bg-[#344f55] text-white font-medium py-2.5 rounded-lg text-sm transition-colors"
            >
              View Full Forecast
            </button>
          </div>
        ...
        <div className="hidden md:flex absolute top-8 right-8 flex-col gap-3">
          ...
          <div className="h-px bg-[#1a2f35] my-2" />
          <button className="w-12 h-12 bg-[#0d1b1e] hover:bg-[#1a2f35] border border-[#1a2f35] rounded-lg flex items-center justify-center text-white transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Forecast Timeline */}
        <div className="md:absolute md:bottom-8 md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-md w-full px-4 py-4 md:px-0 md:py-0 bg-[#0d1b1e] md:bg-transparent">
          <div className="bg-[#0d1b1e] rounded-2xl p-5 md:p-6 border border-[#1a2f35] shadow-2xl">
            ...
            <div className="relative">
              <div className="h-2 bg-[#1a2f35] rounded-full relative overflow-hidden">
                <div className="absolute left-0 top-0 h-full w-1/3 bg-[#00d4ff] rounded-full" />
              </div>
              <div className="absolute top-1/2 -translate-y-1/2 left-1/3 w-4 h-4 bg-white rounded-full border-4 border-[#00d4ff] shadow-lg" />
